...
typedef std::function<void(int trackIndex)> OnPlayOnceListener;
...
public:
	...
	SpineFace(const std::string &rSFileName, float scale = 1);
...
protected:
	...
	virtual bool init( const std::string &rSFileName);
